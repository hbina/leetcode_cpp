...
TEST_CASE("problem_1038") {
  akarithm::TreeNode<double> *input = new akarithm::TreeNode<double>(
      ...
      new akarithm::TreeNode<double>(
          1.0, new akarithm::TreeNode<double>(0.0),
          new akarithm::TreeNode<double>(2.0, nullptr,
                                         new akarithm::TreeNode<double>(3.0))),
      new akarithm::TreeNode<double>(
          6.0, new akarithm::TreeNode<double>(5.0),
          new akarithm::TreeNode<double>(7.0, nullptr,
                                         new akarithm::TreeNode<double>(8.0))));
  const akarithm::TreeNode<double> *expected = new akarithm::TreeNode<double>(
      30.0,
      new akarithm::TreeNode<double>(
          36.0, new akarithm::TreeNode<double>(36.0),
          new akarithm::TreeNode<double>(35.0, nullptr,
                                         new akarithm::TreeNode<double>(33.0))),
      new akarithm::TreeNode<double>(
          21.0, new akarithm::TreeNode<double>(26.0),
          new akarithm::TreeNode<double>(15.0, nullptr,
                                         new akarithm::TreeNode<double>(8.0))));
