...
static constexpr std::tuple<
    ...
    leetcode::ListNode<ValueTy> *,
    leetcode::ListNode<ValueTy> *>
advanceZip(ListNode<ValueTy> *lhs, leetcode::ListNode<ValueTy> *rhs)
{
    if (lhs && rhs)
    {
        if (lhs->val < rhs->val)
...
mergeTwoLists(ListNode<ValueTy> *lhs, leetcode::ListNode<ValueTy> *rhs)
{
    if (lhs && rhs)
    {
        auto [root, lhs_iter, rhs_iter] = advanceZip(lhs, rhs);
        leetcode::ListNode<ValueTy> *iter = root;
